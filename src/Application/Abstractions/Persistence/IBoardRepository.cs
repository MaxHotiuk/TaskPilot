...
public interface IBoardRepository : IRepository<Board, Guid>
{
    ...
    Task<IEnumerable<BoardSearchDto>> SearchBoardsRangeForOwnerAsync(Guid ownerId, Guid organizationId, string searchTerm, int page, int pageSize, CancellationToken cancellationToken = default);
    Task<IEnumerable<BoardSearchDto>> SearchBoardsRangeForUserAsync(Guid userId, Guid organizationId, string searchTerm, int page, int pageSize, CancellationToken cancellationToken = default);
    Task<IEnumerable<BoardSearchDto>> SearchBoardsRangeForMemberAsync(Guid memberId, Guid organizationId, string searchTerm, int page, int pageSize, CancellationToken cancellationToken = default);
